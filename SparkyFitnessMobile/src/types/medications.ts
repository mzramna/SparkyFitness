// Shared types for the Medications module (mobile).
// Mirrors the web frontend types at SparkyFitnessFrontend/src/types/medications.ts
...
export type MedicationDetail = Medication & {
  schedules: MedicationSchedule[];
};
...
// --- Medication type icons mapping (used in the UI) ---
